...
2310-GEN-TRAN-DATA.
    *> Existing logic to generate transaction data
    MOVE 'WEB ' TO WS-TRAN-CHANNEL *> Example: Assign default channel code for test data

2320-WRITE-TRAN-RECORD.
    MOVE WS-TRAN-CHANNEL TO TRAN-CHANNEL-CODE *> Write CHANNEL-CODE to record
